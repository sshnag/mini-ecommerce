...
<head>
    ...
    <title>Luxury Jewels | Home</title>
...
<body class="luxury-home">
    ...
    <nav class="luxury-nav">
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                <a href="/" class="text-2xl font-serif text-gold">LUXURY</a>
    ...
    <section id="featured" class="py-20 bg-white">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                @foreach($latestjewel->take(6)->get() as $product)
    ...
    <footer class="luxury-footer py-12 bg-black text-white">
        <div class="container mx-auto px-6 text-center">
            <p class="text-gold text-xl font-serif mb-6">LUXURY</p>
