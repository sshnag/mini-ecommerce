  ...
  <div class="checkout-card">
    ...
    <form action="{{ route('checkout.shipping.store') }}" method="POST" class="checkout-form">
      ...
      <div class="form-group">
        ...
        <input type="text" id="street" name="street" value="{{ old('street') }}" class="form-input @error('street') is-invalid @enderror" placeholder="123 Main St">
        @error('street')
      ...
      <div class="form-group">
        ...
        <input type="text" id="city" name="city" value="{{ old('city') }}" class="form-input @error('city') is-invalid @enderror" placeholder="New York">
        @error('city')
          <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" id="postal_code" name="postal_code" value="{{ old('postal_code') }}" class="form-input @error('postal_code') is-invalid @enderror" placeholder="10001">
        @error('postal_code')
          <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
