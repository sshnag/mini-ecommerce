   ...
   <div class="card shadow p-4 mb-5 luxury-section d-flex flex-row align-items-center">
    <div class="me-4">
        @if ($user->profile_image)
            <img src="{{ asset($user->profile_image) }}" alt="Profile Image" class="rounded-circle" width="120" height="120">
        @else
            <img src="{{ asset('images/default-profile.jpg') }}" alt="Default Image" class="rounded-circle" width="120" height="120">
        @endif
    </div>
    <div>
                ...
                <tbody>
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td><a href="{{ route('orders.userShow', $order->id) }}" class="btn btn-outline-gold btn-sm">View</a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
