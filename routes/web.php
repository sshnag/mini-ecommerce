...
/*
|--------------------------------------------------------------------------
| Web Routes with Session Separation
|--------------------------------------------------------------------------
*/

Route::middleware(['separate.session'])->group(function () {
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/orders/{order}/confirmation', [OrderController::class, 'orderConfirmation'])->name('orders.confirmation');
...
})->middleware(['auth:admin', 'role:admin|superadmin'])->name('admin.notifications.redirect');
...
Route::prefix('admin')->middleware(['admin.session', 'auth:admin', 'role:admin|superadmin'])->name('admin.')->group(function () {
    ...
    Route::patch('/contacts/{id}/update-status', [ContactController::class, 'updateStatus'])->name('contacts.updateStatus');
